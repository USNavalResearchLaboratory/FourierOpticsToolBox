function [ P ] = parameterSetup_targetAndTurb(Cn2value,Z)
...
P.Target.width = 10*P.U.mm; % diameter of target
...
P.Target.distance = Z; 
P.Target.dx = P.Target.width/10; %Gives 10 grid points in target diameter
...
P.Turb.screens = P.air.screens; %10
...
P.Turb.r0 = (0.423*(2*pi/P.wvl)^2*P.Turb.Cn2.*P.Z).^(-3/5);
P.Turb.r0delta = (0.423*(2*pi/P.wvl)^2*P.Turb.Cn2.*(P.Z/P.Turb.screens)).^(-3/5);
...
P.lens1.dx = P.lens1.diameter/1000; P.Turb.dx = P.lens1.dx;
P.lens1.N = P.N; 
P.lens1.wvl = P.wvl; 
