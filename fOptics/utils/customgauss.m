...
%
%    gauss = customgauss(gsize, radiusx, radiusy, theta, offset, factor, center)
%
...
%                    1x2 vector                     
function ret = customgauss(gsize, radiusx, radiusy, theta, offset, factor, center)

sigmax = sqrt(((radiusx+1)^2)/(2*log(255)));
sigmay = sqrt(((radiusy+1)^2)/(2*log(255)));
ret     = zeros(gsize);
